        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    <!-- menu item Dashboard-->
                    <li>
                        <a href="{{route('home')}}"><i class="ti-home"></i><span class="right-nav-text">Manger Hosoital</span></a>
                    </li>
                    <!-- menu title -->
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{ route('Section.index') }}">list sections</a></li>
                    ...
                    <li>
                        ...
                        <ul id="employees" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Doctor.index')}}">List Doctors</a> </li>
                            <li> <a href="{{ route('Nurse.index')}}">List Nurces</a> </li>
                            <li> <a href="{{ route('Worker.index')}}">List Workers</a> </li>
                        </ul>
                    </li>
                    <!-- menu item todo-->
                    <li>
