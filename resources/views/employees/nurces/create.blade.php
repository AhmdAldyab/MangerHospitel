...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> Nurces</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active">Add Nurce</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form action="{{ route('Nurse.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <br>
                    <div class="row">
                        <div class="col-md-4">
